export const zh = {
  ...
  help: {
    ...
    undo: '撤销参数修改',
    redo: '重做参数修改',
    shortcutsNote: '提示：动画快捷键仅在仿真页面有效',
    about: '关于',
...
export const en = {
  ...
  tabs: {
    ...
    mechanismModel: 'Mechanism Model',
  },
  export: {
    title: 'Export',
  ...
  help: {
    ...
    shortcutsNote: 'Note: Animation shortcuts only work on the Simulation page',
    about: 'About',
